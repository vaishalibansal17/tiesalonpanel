    ...
    ngOnInit() {
        this.forgetPasswordForm = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormGroup"]({
            email: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"](null, [
                ...
                _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].pattern('^[A-Z0-9a-z_.~+-{|}!#$%&()/:;<=>?@`\'",]{1,}@[A-Z0-9a-z]{2,}[.]{1}[A-Za-z.]{2,}$')
            ]),
        });
    }
            ...
            this.httpService.getRequest('POST', 'FORGOT', this.forgetPasswordForm.value).subscribe((response) => {
                if (response.status === 1) {
                    ...
                    this.router.navigateByUrl('/auth')
                        .then(() => {
                        this.helper.sucsTostr(src_app_shared_constants_constant__WEBPACK_IMPORTED_MODULE_7__["MESSAGE"].SUCCESS, src_app_shared_constants_constant__WEBPACK_IMPORTED_MODULE_7__["MESSAGE"].FORGOT_SUC);
                    });
                }
                else {
