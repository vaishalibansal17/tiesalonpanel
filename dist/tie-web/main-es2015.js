...
/* harmony default export */ __webpack_exports__["default"] = ("<ng2-slim-loading-bar [height]=\"'5px'\" [color]=\"'#F96BB3'\"></ng2-slim-loading-bar>\n<p-toast></p-toast>\n<p-toast key=\"myKey1\" position=\"bottom-center\"></p-toast>\n<router-outlet>\n</router-outlet>");
...
/* harmony import */ var _shared_guard_login_guard__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./shared/guard/login.guard */ "./src/app/shared/guard/login.guard.ts");
/* harmony import */ var _page_not_found_page_not_found_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./page-not-found/page-not-found.component */ "./src/app/page-not-found/page-not-found.component.ts");
/* harmony import */ var _invoice_invoice_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./invoice/invoice.component */ "./src/app/invoice/invoice.component.ts");
...
const routes = [
    ...
    { path: '', loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e(0), __webpack_require__.e("common"), __webpack_require__.e(8)]).then(__webpack_require__.bind(null, /*! ./home/home.module */ "./src/app/home/home.module.ts")).then(m => m.HomeModule), canActivate: [_shared_guard_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]] },
    ...
    { path: 'reset-freelancer/:token', loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e(0), __webpack_require__.e("common"), __webpack_require__.e(53)]).then(__webpack_require__.bind(null, /*! ./reset-freelancer/reset-freelancer.module */ "./src/app/reset-freelancer/reset-freelancer.module.ts")).then(m => m.ResetFreelancerModule) },
    { path: 'invoice/:id', component: _invoice_invoice_component__WEBPACK_IMPORTED_MODULE_6__["InvoiceComponent"], canActivate: [_shared_guard_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]] },
...
/* harmony import */ var _shared_service_http_request_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./shared/service/http-request.service */ "./src/app/shared/service/http-request.service.ts");
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm2015/http.js");
/* harmony import */ var _shared_interceptor_api_prefix_interceptor__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./shared/interceptor/api.prefix.interceptor */ "./src/app/shared/interceptor/api.prefix.interceptor.ts");
/* harmony import */ var _shared_interceptor_offline_interceptor__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./shared/interceptor/offline.interceptor */ "./src/app/shared/interceptor/offline.interceptor.ts");
/* harmony import */ var _shared_interceptor_loader_interceptor__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./shared/interceptor/loader.interceptor */ "./src/app/shared/interceptor/loader.interceptor.ts");
...
/* harmony import */ var _shared_interceptor_error_interceptor__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./shared/interceptor/error.interceptor */ "./src/app/shared/interceptor/error.interceptor.ts");
/* harmony import */ var _shared_service_helper_service__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./shared/service/helper.service */ "./src/app/shared/service/helper.service.ts");
/* harmony import */ var _shared_service_translate_service__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./shared/service/translate.service */ "./src/app/shared/service/translate.service.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            _app_component__WEBPACK_IMPORTED_MODULE_4__["AppComponent"], _page_not_found_page_not_found_component__WEBPACK_IMPORTED_MODULE_19__["PageNotFoundComponent"], _invoice_invoice_component__WEBPACK_IMPORTED_MODULE_20__["InvoiceComponent"]
        ],
        imports: [
        ...
        providers: [_shared_service_http_request_service__WEBPACK_IMPORTED_MODULE_6__["HttpRequestService"], _shared_service_helper_service__WEBPACK_IMPORTED_MODULE_13__["Helper"], _shared_service_translate_service__WEBPACK_IMPORTED_MODULE_14__["TranslateService"], primeng_api__WEBPACK_IMPORTED_MODULE_18__["MessageService"],
            { provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_7__["HTTP_INTERCEPTORS"], useClass: _shared_interceptor_api_prefix_interceptor__WEBPACK_IMPORTED_MODULE_8__["ApiPrefixInterceptor"], multi: true },
            { provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_7__["HTTP_INTERCEPTORS"], useClass: _shared_interceptor_offline_interceptor__WEBPACK_IMPORTED_MODULE_9__["OfflineInterceptor"], multi: true },
            { provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_7__["HTTP_INTERCEPTORS"], useClass: _shared_interceptor_loader_interceptor__WEBPACK_IMPORTED_MODULE_10__["LoaderInterceptor"], multi: true },
            { provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_7__["HTTP_INTERCEPTORS"], useClass: _shared_interceptor_error_interceptor__WEBPACK_IMPORTED_MODULE_12__["ErrorInterceptor"], multi: true },
            { provide: _angular_core__WEBPACK_IMPORTED_MODULE_2__["APP_INITIALIZER"], useFactory: setupTranslateFactory, deps: [_shared_service_translate_service__WEBPACK_IMPORTED_MODULE_14__["TranslateService"]], multi: true }
        ],
...
/* harmony import */ var _shared_service_error_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../shared/service/error.service */ "./src/app/shared/service/error.service.ts");
...
let InvoiceComponent = class InvoiceComponent {
    constructor(httpService, titleService, routes, errsrv) {
    ...
    htmlToPDF() {
        ...
        return html2canvas__WEBPACK_IMPORTED_MODULE_6___default()(element, { scale: 2 }).then(canvas => {
            canvas.getContext('2d');
            var imgData = canvas.toDataURL("image/jpeg", 1.0);
            var pdf = new jspdf__WEBPACK_IMPORTED_MODULE_5__('p', 'pt', [PDF_Width, PDF_Height]);
            ...
            let datePipe = new _angular_common__WEBPACK_IMPORTED_MODULE_7__["DatePipe"]("en-US");
...
InvoiceComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./invoice.component.scss */ "./src/app/invoice/invoice.component.scss")).default]
    })
], InvoiceComponent);
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _service_translate_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../service/translate.service */ "./src/app/shared/service/translate.service.ts");
...
const BASE_URL = _environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].END_POINT;
const APIURLS = {
...
let AuthGuard = class AuthGuard {
    constructor(HttpService, myRoute) {
        this.HttpService = HttpService;
...
/* harmony import */ var rxjs_add_operator_delay__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! rxjs/add/operator/delay */ "./node_modules/rxjs-compat/_esm2015/add/operator/delay.js");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "OfflineInterceptor", function() { return OfflineInterceptor; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm2015/http.js");
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _pipes_translate_pipe__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../_pipes/translate.pipe */ "./src/app/shared/_pipes/translate.pipe.ts");



let ApplicationpipeModule = class ApplicationpipeModule {
};
ApplicationpipeModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [
        // dep modules
        ],
        declarations: [
            _pipes_translate_pipe__WEBPACK_IMPORTED_MODULE_2__["TranslatePipe"]
        ],
        exports: [
            _pipes_translate_pipe__WEBPACK_IMPORTED_MODULE_2__["TranslatePipe"]
        ]
...
let Helper = class Helper {
    ...
    utcDate(data, time, isUTC = true) {
        var date = new Date(data), mnth = ("0" + (date.getMonth())).slice(-2), day = ("0" + date.getDate()).slice(-2);
        var m1 = moment_timezone__WEBPACK_IMPORTED_MODULE_2___default.a.utc([Number(date.getFullYear()), Number(mnth), Number(day)]);
...
let HttpRequestService = class HttpRequestService {
    ...
    getRequest(type, requestUrl, data, queryParams) {
        if (type === 'GET') {
            ...
            return this.http.get(this.getApi(requestUrl) + '/' + data + (queryParams ? `?${queryParams}` : ''));
        }
        else if (type === 'POST') {
...
module.exports = __webpack_require__(/*! /Users/brainmobimac/Abhishek/angular/tie-web/src/main.ts */"./src/main.ts");
