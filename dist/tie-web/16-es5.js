...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([[16], {
  ...
  function srcAppAuthLoginLoginComponentScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = ".main-right .btn-submit {\n  margin: 0px 0px 10px;\n}\n\np.color.error {\n  top: 0px;\n}\n\n#slideshow {\n  display: block;\n}\n\n#image {\n  opacity: 0;\n  -webkit-transition: opacity 1s linear 0s;\n  transition: opacity 1s linear 0s;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
      ...
      _createClass(LoginComponent, [{
        ...
        value: function ngOnInit() {
          ...
          function startSlideshow() {
            ...
            image.style.opacity = '100'; //Change opacity back to 0, 1 second before changing the picture
          ...
          startSlideshow(); // console.log(this.trnsalte.currentLang);
            ...
            this.httpService.getRequest('POST', 'LOGIN', this.loginfrm.value).subscribe(function (data) {
              if (data.status) {
                var _data$res = data.res,
                    ...
                    name = _data$res.name,
                    c_policy = _data$res.c_policy,
                    is_charge = _data$res.is_charge,
                    allow_multi = _data$res.allow_multi,
                    is_notif = _data$res.is_notif,
                    onl_booking = _data$res.onl_booking,
                    slot_duration = _data$res.slot_duration;
                ...
                localStorage.setItem('salon', JSON.stringify({
                  ...
                  'onl_booking': onl_booking,
                  'slt_dur': slot_duration
                }));
