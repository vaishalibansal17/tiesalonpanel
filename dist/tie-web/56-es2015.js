...
const routes = [
    { path: '', loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e(2), __webpack_require__.e("common"), __webpack_require__.e(45)]).then(__webpack_require__.bind(null, /*! ./list/list.module */ "./src/app/home/staff/list/list.module.ts")).then(mod => mod.ListModule), data: { title: "List", status: false } },
    ...
    { path: 'info/:id', loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e(2), __webpack_require__.e("common"), __webpack_require__.e(46)]).then(__webpack_require__.bind(null, /*! ./staffdetail/staffdetail.module */ "./src/app/home/staff/staffdetail/staffdetail.module.ts")).then(mod => mod.StaffdetailModule), data: { title: "Info", status: false } },
    { path: 'review/:id', loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e(2), __webpack_require__.e("common"), __webpack_require__.e(11)]).then(__webpack_require__.bind(null, /*! ./staffreview/staffreview.module */ "./src/app/home/staff/staffreview/staffreview.module.ts")).then(mod => mod.StaffreviewModule), data: { title: "Info / Review", status: false } },
];
