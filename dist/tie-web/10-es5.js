...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([[10], {
    ...
    */
    ...
    function (_super) {
      ...
      SimpleDayGridEventRenderer.prototype.renderSegHtml = function (seg, mirrorInfo) {
        ...
        '</span>';
        return '<a class="' + classes.join(' ') + '"' + (eventDef.url ? ' href="' + Object(_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__["htmlEscape"])(eventDef.url) + '"' : '') + (skinCss ? ' style="' + skinCss + '"' : '') + '>' + '<div class="fc-content">' + (options.dir === 'rtl' ? titleHtml + ' ' + timeHtml : // put a natural space in between
        timeHtml + ' ' + titleHtml //
    ...
    function (_super) {
      ...
      DayGrid.prototype.renderNumberCellHtml = function (date) {
        ...
        if (this.renderProps.cellWeekNumbersVisible && date.getUTCDay() === weekCalcFirstDow) {
          html += Object(_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__["buildGotoAnchorHtml"])(view, {
            date: date,
            type: 'week'
          }, {
        ...
        if (isDayNumberVisible) {
          html += Object(_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__["buildGotoAnchorHtml"])(view, date, {
            'class': 'fc-day-number'
      ...
      function DayGridView(context, viewSpec, dateProfileGenerator, parentEl) {
        ...
        _this.renderHeadIntroHtml = function () {
          ...
          if (_this.colWeekNumbersVisible) {
            ...
            Object(_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__["htmlEscape"])(_this.opt('weekLabel')) + '</span>' + '</th>';
          }
    ...
    */
    ...
    function (_super) {
      ...
      function TimeGridView(context, viewSpec, dateProfileGenerator, parentEl) {
        ...
        _this.renderDayGridBgIntroHtml = function () {
          ...
          Object(_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__["getAllDayHtml"])(_this) + '</span>' + '</td>';
        }; // Generates the HTML that goes before all other types of cells.
        // Affects content-skeleton, mirror-skeleton, highlight-skeleton for both the time-grid and day-grid.
    ...
    function (_super) {
      ...
      SimpleTimeGrid.prototype.render = function (props) {
        ...
        this.timeGrid.receiveProps(_assign3({}, this.slicer.sliceProps(props, dateProfile, null, this.timeGrid, dayRanges), {
          dateProfile: dateProfile,
  ...
  function srcAppHomeManageCalenderManagecalenderManagecalenderComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var src_app_shared_service_http_request_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    ...
    /*#__PURE__*/
    function () {
      function ManagecalenderComponent(http, route, httpService, helper) {
        ...
        this.calendarEvents = [// { title: 'Event Now Event Now Event Now', start: new Date('Mon Feb 03 2020 00:00:00 GMT+0530 (India Standard Time)') },
      ...
      _createClass(ManagecalenderComponent, [{
        ...
        key: "getList",
        value: function getList(month, year) {
          var _this2 = this;

          // ?month=${month}&year=${year}
          this.httpService.getRequest('GET', 'BOOKING', "month=".concat(month, "&year=").concat(year)).subscribe(function (rs) {
            if (rs.res) {
              var bkngs = rs.res.bkngs;
              bkngs.forEach(function (element) {
                _this2.calendarEvents.push({
                  title: element.service,
                  start: new Date(element.bookDateTime),
                  id: element._id //  url: `booking/info/${element._id}`
        ...
        value: function eventClicked(calDate) {
          var path = calDate.event.id;
          this.route.navigate(['/booking/info', path]);
        }
      }, {
        key: "handleDatesRender",
        value: function handleDatesRender($event) {
    ...
    ManagecalenderComponent.ctorParameters = function () {
      return [{
        ...
        type: src_app_shared_service_http_request_service__WEBPACK_IMPORTED_MODULE_8__["HttpRequestService"]
      }, {
        type: src_app_shared_service_helper_service__WEBPACK_IMPORTED_MODULE_7__["Helper"]
      }];
    };

    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('calendar', {
      static: true
    })], ManagecalenderComponent.prototype, "calendarComponent", void 0);
