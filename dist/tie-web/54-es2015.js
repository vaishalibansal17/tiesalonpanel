...
const routes = [
    { path: '', loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(14)]).then(__webpack_require__.bind(null, /*! ./list/list.module */ "./src/app/home/bookings/list/list.module.ts")).then(mod => mod.ListModule), data: { title: "List", status: false } },
    // { path: 'add', loadChildren: () => import('./addstaff/addstaff.module').then(mod => mod.AddstaffModule), data: { title: "Add", status: false } },
    { path: 'info/:id', loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e(1), __webpack_require__.e(10)]).then(__webpack_require__.bind(null, /*! ./bookingdetail/bookingdetail.module */ "./src/app/home/bookings/bookingdetail/bookingdetail.module.ts")).then(mod => mod.BookingdetailModule), data: { title: "Info", status: false } },
];
...
/* harmony import */ var src_app_shared_pipes_translate_pipe__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/app/shared/_pipes/translate.pipe */ "./src/app/shared/_pipes/translate.pipe.ts");
