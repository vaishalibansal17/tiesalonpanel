...
let AddbookingsComponent = class AddbookingsComponent {
    ...
    ngOnInit() {
        ...
        this.profile = new _angular_forms__WEBPACK_IMPORTED_MODULE_8__["FormGroup"]({
            ...
            dttime: new _angular_forms__WEBPACK_IMPORTED_MODULE_8__["FormControl"](null, [
                _angular_forms__WEBPACK_IMPORTED_MODULE_8__["Validators"].required
            ]),
    ...
    slctsrv(state) {
        ...
        if (!this.httpService.arraySearch(this.sendServ, state)) {
            this.chips.push({ id: state._id, cat_name: lodash__WEBPACK_IMPORTED_MODULE_10__["startCase"](lodash__WEBPACK_IMPORTED_MODULE_10__["camelCase"](state.cat_name)), title: lodash__WEBPACK_IMPORTED_MODULE_10__["startCase"](lodash__WEBPACK_IMPORTED_MODULE_10__["camelCase"](state.cat_name)), cost: state.price, duration: state.duration });
