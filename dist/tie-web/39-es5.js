...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([[39], {
  ...
  function srcAppHomeReportSalesSalesComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var src_app_shared_constants_constant__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
    ...
    /*#__PURE__*/
    function () {
      function SalesComponent(list, httpservice, trns) {
      ...
      _createClass(SalesComponent, [{
        ...
        value: function getReport() {
          ...
          this.loadlist(); // this.dataSource.usersData.subscribe((val) => this.detail = val);
        ...
        value: function exportCSV(data) {
          ...
          var obj;
          var i = 0;
          this.httpservice.getRequest('GET', 'REPORT', "all=true").subscribe(function (rs) {
            var datePipe = new _angular_common__WEBPACK_IMPORTED_MODULE_10__["DatePipe"]('en-US');
            rs.res.wlkUsr.forEach(function (element) {
              obj = {
                "Serial": ++i,
                "Name": element.name ? element.name : 'NA',
                "Services": element.service ? element.service.map(function (y) {
                  return y.title;
                }).join(', ') : "NA",
            ...
            var options = {
              noDownload: false,
              headers: ["Serial", "Name", 'Services', 'Service at', 'Booking-Id', 'Date']
            };
