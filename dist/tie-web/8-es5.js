...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([[8], {
  ...
  function srcAppHomeHeaderHeaderComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function HeaderComponent(httpservice, router, message, trns) {
        var _this = this;
        ...
        this._unsubs = this.router.events.subscribe(function (event) {
          if (event instanceof _angular_router__WEBPACK_IMPORTED_MODULE_5__["NavigationStart"]) {
            // Show loading indicator
            _this.route = event.url == '/dashboard' || event.url == '/' ? "".concat(_this.trns.data["WELCOMETOOUR"]).concat(_this.detail ? ' ' + _this.detail.name + ' Admin' : '') : event.url.split('/')[1].includes('-') ? _this.check(event.url.split('/')[1]) : event.url.split('/')[1];
          }
          ...
          if (event instanceof _angular_router__WEBPACK_IMPORTED_MODULE_5__["NavigationError"]) {
            // Hide loading indicator
            console.log(event.url); // Present error to user
      ...
      _createClass(HeaderComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.httpservice.getRequest('GET', 'NOTI_LIST', 'limit=3').subscribe(function (res) {
            if (res.status) {
              _this2.imgurl = res.res.uP;
              _this2.list = res.res.notf;
              _this2.detailList = res.res;
              _this2.ttlunread = res.res.unread;
            } else {
              new Error();
            }
    ...
    var routes = [{
      ...
      children: [{
        ...
        loadChildren: function loadChildren() {
          return Promise.all(
          /*! import() */
          [__webpack_require__.e(3), __webpack_require__.e(4)]).then(__webpack_require__.bind(null,
  ...
  function srcAppHomeSidebarSidebarComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function SidebarComponent(element, messageserv, router) {
      ...
      _createClass(SidebarComponent, [{
        ...
        value: function route(_route) {
          ...
          this.messageserv.sendRoute(_route);
          this.router.navigateByUrl('/' + _route).then(function () {
            return _this3.router.isActive(_this3.router.url, true);
          });
        }
      }]);
  ...
  function srcAppHomeSupportSupportComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      ...
      _createClass(SupportComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          var chatbox = jquery__WEBPACK_IMPORTED_MODULE_2___default.a.noConflict();
          chatbox(function () {
            chatbox(".chatbox-open").click(function () {
              return chatbox(".chatbox-popup, .chatbox-close").fadeIn();
            });
            chatbox(".chatbox-close").click(function () {
              return chatbox(".chatbox-popup, .chatbox-close").fadeOut();
            });
          });
        }
      }]);
            ...
            childrenRoutes.forEach(function (routes) {
              if (routes.outlet === "primary") {
                ...
                if (routes.snapshot.data.title !== undefined) {
                  ...
                  if (!_this4.tempState.includes(routes.snapshot.data.title)) {
                    _this4.tempState.push(routes.snapshot.data.title);

                    if (routes.snapshot.data.title.includes('/')) {
                      var path = routes.snapshot.data.title.split('/');
                      var routepath = url.split(lodash__WEBPACK_IMPORTED_MODULE_4___default.a.toLower(lodash__WEBPACK_IMPORTED_MODULE_4___default.a.trim(path[1])));
  ...
  function srcAppSharedServiceMessageServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      ...
      _createClass(MessageService, [{
        ...
        key: "setBooking",
        value: function setBooking(data) {
          this.booking = data;
        }
      }, {
        key: "getBooking",
