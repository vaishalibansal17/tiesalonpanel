  ...
  function srcAppHomeHeaderHeaderComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      ...
      _createClass(HeaderComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {// this.router.events.pipe(
    ...
    var routes = [{
      ...
      children: [{
        ...
        loadChildren: function loadChildren() {
          return Promise.all(
          /*! import() */
          [__webpack_require__.e(4), __webpack_require__.e(5)]).then(__webpack_require__.bind(null,
        ...
        loadChildren: function loadChildren() {
          return Promise.all(
          /*! import() */
          [__webpack_require__.e(0), __webpack_require__.e(33)]).then(__webpack_require__.bind(null,
      ...
      _createClass(SidebarComponent, [{
        ...
        value: function route(_route) {
          ...
          this.router.navigateByUrl('/' + _route).then(function () {
            return _this2.router.isActive(_this2.router.url, true);
          });
        }
      }]);
            ...
            childrenRoutes.forEach(function (routes) {
              if (routes.outlet === "primary") {
                ...
                if (routes.snapshot.data.title !== undefined) {
                  ...
                  if (!_this3.tempState.includes(routes.snapshot.data.title)) {
                    _this3.tempState.push(routes.snapshot.data.title);
