...
const routes = [{
        ...
        children: [
            { path: '', loadChildren: () => __webpack_require__.e(/*! import() */ 34).then(__webpack_require__.bind(null, /*! ./earninglist/earninglist.module */ "./src/app/home/report/earning/earninglist/earninglist.module.ts")).then(mod => mod.EarninglistModule), data: { title: "Earning", status: false } },
            { path: 'day-list', loadChildren: () => __webpack_require__.e(/*! import() */ 33).then(__webpack_require__.bind(null, /*! ./earningdaylist/earningdaylist.module */ "./src/app/home/report/earning/earningdaylist/earningdaylist.module.ts")).then(mod => mod.EarningdaylistModule), },
            { path: 'month-list', loadChildren: () => __webpack_require__.e(/*! import() */ 35).then(__webpack_require__.bind(null, /*! ./earningmonthlist/earningmonthlist.module */ "./src/app/home/report/earning/earningmonthlist/earningmonthlist.module.ts")).then(mod => mod.EarningmonthlistModule), }
        ]
    },];
