...
const routes = [{
        ...
        children: [
            ...
            { path: 'add-user', loadChildren: () => __webpack_require__.e(/*! import() */ 28).then(__webpack_require__.bind(null, /*! ./add/add.module */ "./src/app/home/walking-user/add/add.module.ts")).then(mod => mod.AddModule), data: { title: "Add User", status: false } },
            { path: 'add-booking', loadChildren: () => __webpack_require__.e(/*! import() */ 29).then(__webpack_require__.bind(null, /*! ./addbookings/addbookings.module */ "./src/app/home/walking-user/addbookings/addbookings.module.ts")).then(mod => mod.AddbookingsModule), data: { title: "Add Booking", status: false } },
            { path: 'calender', loadChildren: () => __webpack_require__.e(/*! import() */ 30).then(__webpack_require__.bind(null, /*! ./calender/calender.module */ "./src/app/home/walking-user/calender/calender.module.ts")).then(mod => mod.CalenderModule), data: { title: "Calender", status: false } },
            { path: 'calender-list', loadChildren: () => __webpack_require__.e(/*! import() */ 32).then(__webpack_require__.bind(null, /*! ./calenderlist/calenderlist.module */ "./src/app/home/walking-user/calenderlist/calenderlist.module.ts")).then(mod => mod.CalenderlistModule), data: { title: "Calender List", status: false } },
            { path: 'calender-info', loadChildren: () => __webpack_require__.e(/*! import() */ 31).then(__webpack_require__.bind(null, /*! ./calenderdetail/calenderdetail.module */ "./src/app/home/walking-user/calenderdetail/calenderdetail.module.ts")).then(mod => mod.CalenderdetailModule), data: { title: "Calender Info", status: false } },
        ]
    }];
