...
const routes = [{
        ...
        children: [
            ...
            { path: 'chat', loadChildren: () => __webpack_require__.e(/*! import() */ 20).then(__webpack_require__.bind(null, /*! ./chat-management/chat-management.module */ "./src/app/home/chat-management/chat-management.module.ts")).then(mod => mod.ChatManagementModule), data: { title: "Chat Management", status: true } },
            { path: 'promocode', loadChildren: () => __webpack_require__.e(/*! import() */ 5).then(__webpack_require__.bind(null, /*! ./promocode/promocode.module */ "./src/app/home/promocode/promocode.module.ts")).then(mod => mod.PromocodeModule), data: { title: "Promocode", status: true } },
            { path: 'cancellation-policy', loadChildren: () => __webpack_require__.e(/*! import() */ 17).then(__webpack_require__.bind(null, /*! ./cancellation-policy/cancellation-policy.module */ "./src/app/home/cancellation-policy/cancellation-policy.module.ts")).then(mod => mod.CancellationPolicyModule), },
            ...
            { path: 'feedback', loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(21)]).then(__webpack_require__.bind(null, /*! ./feedback/feedback.module */ "./src/app/home/feedback/feedback.module.ts")).then(mod => mod.FeedbackModule), data: { title: "Feedback", status: true } },
            { path: 'about-us', loadChildren: () => __webpack_require__.e(/*! import() */ 15).then(__webpack_require__.bind(null, /*! ./aboutus/aboutus.module */ "./src/app/home/aboutus/aboutus.module.ts")).then(mod => mod.AboutusModule), data: { title: "About Us", status: true } },
        ]
    },];
