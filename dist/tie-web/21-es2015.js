...
let CancelpolicyComponent = class CancelpolicyComponent {
    ...
    openDialog(isCharge) {
        ...
        const dialogRef = this.dialog.open(src_app_shared_confim_dialog_confim_dialog_component__WEBPACK_IMPORTED_MODULE_3__["ConfimDialogComponent"], { width: '500px', disableClose: true, data: { msg: msg, btn: this.trns.transform('OK'), cncl: this.trns.transform('CANCEL') } });
