...
const routes = [{
        ...
        children: [
            ...
            { path: 'notification', loadChildren: () => __webpack_require__.e(/*! import() */ 18).then(__webpack_require__.bind(null, /*! ./notification/notification.module */ "./src/app/home/notification/notification.module.ts")).then(mod => mod.NotificationModule), data: { title: "Notification", status: false } },
            { path: 'profile', loadChildren: () => __webpack_require__.e(/*! import() */ 28).then(__webpack_require__.bind(null, /*! ./profile/profile.module */ "./src/app/home/profile/profile.module.ts")).then(mod => mod.ProfileModule), data: { title: "Profile", status: true } },
            ...
            { path: 'staff', loadChildren: () => __webpack_require__.e(/*! import() */ 29).then(__webpack_require__.bind(null, /*! ./staff/staff.module */ "./src/app/home/staff/staff.module.ts")).then(mod => mod.StaffModule), data: { title: "Staff", status: true } },
            { path: 'report', loadChildren: () => __webpack_require__.e(/*! import() */ 20).then(__webpack_require__.bind(null, /*! ./report/report.module */ "./src/app/home/report/report.module.ts")).then(mod => mod.ReportModule), data: { title: "Report", status: true } },
            { path: 'manage-calender', loadChildren: () => __webpack_require__.e(/*! import() */ 17).then(__webpack_require__.bind(null, /*! ./manage-calender/manage-calender.module */ "./src/app/home/manage-calender/manage-calender.module.ts")).then(mod => mod.ManageCalenderModule), data: { title: "Notification", status: true } },
            { path: 'booking', loadChildren: () => __webpack_require__.e(/*! import() */ 14).then(__webpack_require__.bind(null, /*! ./bookings/bookings.module */ "./src/app/home/bookings/bookings.module.ts")).then(mod => mod.BookingsModule), data: { title: "Bookings", status: true } },
            ...
            { path: 'walking-user', loadChildren: () => __webpack_require__.e(/*! import() */ 26).then(__webpack_require__.bind(null, /*! ./walking-user/walking-user.module */ "./src/app/home/walking-user/walking-user.module.ts")).then(mod => mod.WalkingUserModule), data: { title: "Walking User", status: true } },
            { path: 'chat', loadChildren: () => __webpack_require__.e(/*! import() */ 16).then(__webpack_require__.bind(null, /*! ./chat-management/chat-management.module */ "./src/app/home/chat-management/chat-management.module.ts")).then(mod => mod.ChatManagementModule), data: { title: "Chat Management", status: true } },
            { path: 'promocode', loadChildren: () => __webpack_require__.e(/*! import() */ 2).then(__webpack_require__.bind(null, /*! ./promocode/promocode.module */ "./src/app/home/promocode/promocode.module.ts")).then(mod => mod.PromocodeModule), data: { title: "Promocode", status: true } },
            { path: 'cancellation-policy', loadChildren: () => __webpack_require__.e(/*! import() */ 15).then(__webpack_require__.bind(null, /*! ./cancellation-policy/cancellation-policy.module */ "./src/app/home/cancellation-policy/cancellation-policy.module.ts")).then(mod => mod.CancellationPolicyModule), data: { title: "Cancellation Policy", status: true } },
            { path: 'reviews', loadChildren: () => __webpack_require__.e(/*! import() */ 21).then(__webpack_require__.bind(null, /*! ./reviews/reviews.module */ "./src/app/home/reviews/reviews.module.ts")).then(mod => mod.ReviewsModule) }
        ]
    },];
