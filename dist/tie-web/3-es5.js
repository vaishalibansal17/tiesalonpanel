...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([[3], {
  ...
  function srcAppHomeStaffListListComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var StaffDeleteDialogBox =
    /*#__PURE__*/
    function () {
      function StaffDeleteDialogBox(httpservice, errsrv, trns, dialogRef, data) {
      ...
      _createClass(StaffDeleteDialogBox, [{
        key: "delete",
        value: function _delete() {
          var _this5 = this;

          this.httpservice.getRequest('DELETE', 'STAFF', "".concat(this.id)).subscribe(function (response) {
            if (response.status === 1) {
              _this5.httpservice.sucsTostr(_this5.trns.transform('SUCCESS'), _this5.trns.transform('DELETE_STAFF'));

              _this5.dialogRef.close();
            } else {
              if (response.err) _this5.errsrv.handleError(response.err.errCode);
              return false;
            }
          }, function (error) {
            _this5.errsrv.handleError(0);
          });
        }
      }, {
        key: "close",
    ...
    StaffDeleteDialogBox.ctorParameters = function () {
      return [{
        type: src_app_shared_service_http_request_service__WEBPACK_IMPORTED_MODULE_7__["HttpRequestService"]
      }, {
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__param"](4, Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"])(_angular_material__WEBPACK_IMPORTED_MODULE_2__["MAT_DIALOG_DATA"]))], StaffDeleteDialogBox);
    /***/
  },
      ...
      _createClass(ListDataSource, [{
        ...
        value: function load(listObj, dataObj) {
          ...
          this.listService.staffListing(listObj, dataObj).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function (err) {
            ...
            return _this6.loadingUsers.next(false);
          })).subscribe(function (data) {
            if (data['res'] && data['res']['list']) {
              _this6.usersData.next(data['res']['list']);

              if (!listObj.search) {
                _this6.countInfo.next(data['res']['total']);
              } else {
                if (data['res']['total'] === 0) {
                  _this6.countInfo.next(1);
                } else {
                  _this6.countInfo.next(data['res']['total']);
                }
              }

              _this6.extra.next(data['res']['bp']);
            }
          });
        }
      }, {
