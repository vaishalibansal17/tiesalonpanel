      ...
      _createClass(SlideshowComponent, [{
          ...
          if (Object(_angular_common__WEBPACK_IMPORTED_MODULE_1__["isPlatformServer"])(this.platform_id)) {
            ...
            if (firstSlideFromTransferState === null) {
              ...
              loadImage.addEventListener('load', function () {
                _this82.slides[tmpIndex].image = typeof tmpImage === 'string' ? {
                  url: tmpImage
                } : tmpImage;
                _this82.slides[tmpIndex].loaded = true;
              });
            } else {
        ...
        value: function loadRemainingSlides() {
          ...
          var _loop = function _loop(i) {
            if (!_this83.slides[i].loaded) {
              new Promise(function (resolve) {
                var
                /** @type {?} */
                tmpImage = _this83.imageUrls[i];
                var
                /** @type {?} */
                loadImage = new Image();
                loadImage.addEventListener('load', function () {
                  _this83.slides[i].image = typeof tmpImage === 'string' ? {
                    url: tmpImage
                  } : tmpImage;
                  _this83.slides[i].loaded = true;
                  resolve();
                });
                loadImage.src = typeof tmpImage === 'string' ? tmpImage : tmpImage.url;
              });
          ...
          if (stopAutoPlay === true || this.autoPlay === false) {
            if (this._autoplayIntervalId) {
              this._ngZone.runOutsideAngular(function () {
                return clearInterval(_this84._autoplayIntervalId);
              });
            ...
            this._ngZone.runOutsideAngular(function () {
              _this84._autoplayIntervalId = setInterval(function () {
                if (!_this84.autoPlayWaitForLazyLoad || _this84.autoPlayWaitForLazyLoad && _this84.slides[_this84.slideIndex].loaded) {
                  _this84._ngZone.run(function () {
                    return _this84.slide(1);
                  });
                }
              }, _this84.autoPlayInterval);
            });
          }
        }
        /**
        ...
        value: function checkCache() {
          ...
          return !(this._urlCache.length === this.imageUrls.length && this._urlCache.every(function (cacheElement, i) {
            return cacheElement === _this85.imageUrls[i];
          }));
        }
        /**
