...
const routes = [{
        ...
        children: [
            { path: '', loadChildren: () => __webpack_require__.e(/*! import() */ 19).then(__webpack_require__.bind(null, /*! ./cancelpolicy/cancelpolicy.module */ "./src/app/home/cancellation-policy/cancelpolicy/cancelpolicy.module.ts")).then(mod => mod.CancelpolicyModule), },
            { path: 'update-policy', loadChildren: () => __webpack_require__.e(/*! import() */ 20).then(__webpack_require__.bind(null, /*! ./cancelupdate/cancelupdate.module */ "./src/app/home/cancellation-policy/cancelupdate/cancelupdate.module.ts")).then(mod => mod.CancelupdateModule), data: { title: "Update Policy", status: false } },
        ]
    }];
