...
const routes = [
    ...
    { path: 'add-user', loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(48)]).then(__webpack_require__.bind(null, /*! ./add/add.module */ "./src/app/home/walking-user/add/add.module.ts")).then(mod => mod.AddModule), data: { title: "Add User", status: false } },
    { path: 'add-booking', loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e(49)]).then(__webpack_require__.bind(null, /*! ./addbookings/addbookings.module */ "./src/app/home/walking-user/addbookings/addbookings.module.ts")).then(mod => mod.AddbookingsModule), data: { title: "Add Booking", status: false } },
];
