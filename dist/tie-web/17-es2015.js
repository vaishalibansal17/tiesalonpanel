...
const routes = [{
        ...
        data: { title: "Booking" },
        children: [
            { path: '', loadChildren: () => __webpack_require__.e(/*! import() */ 13).then(__webpack_require__.bind(null, /*! ./list/list.module */ "./src/app/home/bookings/list/list.module.ts")).then(mod => mod.ListModule), data: { title: "List", status: false } },
            ...
            { path: 'info', loadChildren: () => __webpack_require__.e(/*! import() */ 12).then(__webpack_require__.bind(null, /*! ./bookingdetail/bookingdetail.module */ "./src/app/home/bookings/bookingdetail/bookingdetail.module.ts")).then(mod => mod.BookingdetailModule), data: { title: "Info", status: false } },
        ]
    }];
