...
let ListComponent = class ListComponent {
    ...
    ;
    openDialog(id) {
        const dialogRef = this.dialog.open(src_app_shared_confim_dialog_confim_dialog_component__WEBPACK_IMPORTED_MODULE_11__["ConfimDialogComponent"], { width: '500px', disableClose: true, data: { msg: "Are you sure you want to accept/decline the Booking?", btn: this.trns.transform('ACCEPT'), cncl: this.trns.transform('CANCEL') } });
