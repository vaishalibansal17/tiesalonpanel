...
/* harmony import */ var _staff_list_list_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../staff/list/list.component */ "./src/app/home/staff/list/list.component.ts");
...
let ListComponent = class ListComponent {
    ...
    ;
    openDialog(id) {
        const dialogRef = this.dialog.open(_staff_list_list_component__WEBPACK_IMPORTED_MODULE_7__["StaffDeleteDialogBox"], { width: '500px', disableClose: true, data: { id: id } });
    ...
    ngAfterViewInit() {
        ...
        Object(rxjs__WEBPACK_IMPORTED_MODULE_8__["merge"])(this.sort.sortChange, this.paginator.page)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_9__["tap"])(() => this.loadStaffList()))
            .subscribe();
    }
    loadStaffList() {
